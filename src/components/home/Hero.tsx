              ...
              <div>
                ...
                >
                  <a
                    ...
                    className="group flex items-center justify-center gap-3 px-6 sm:px-8 py-4 bg-gradient-to-r from-gold to-gold-dark text-navy font-bold text-base sm:text-lg rounded-2xl hover:shadow-2xl hover:shadow-gold/25 hover:scale-[1.02] transition-all duration-300"
                  >
