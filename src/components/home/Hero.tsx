  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/rooftop-panels-city.jpg"
          alt="Solar panels installation in Zimbabwe"
      ...
      {/* Floating Orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-blue/10 rounded-full blur-[120px] animate-float" />
      <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-gold/10 rounded-full blur-[100px] animate-float" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-4xl">
          ...
          >
            Say goodbye to power cuts and reduce your electricity bills with
            professional solar solutions designed, installed and maintained by
            Masvingo&apos;s leading energy experts.
          </motion.p>
          ...
          >
            ...
            <a
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 glass rounded-2xl text-white font-semibold text-lg hover:bg-white/10 transition-all duration-300 gradient-border"
            >
              <svg
